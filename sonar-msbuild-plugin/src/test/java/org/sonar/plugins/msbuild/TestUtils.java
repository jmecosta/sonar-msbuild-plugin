...
public class TestUtils {
  ...
  public static Project mockProject() {
    ...
    testDirs.add(loadResource("/org/sonar/plugins/msbuild/SampleProjectTests"));
  ...
  public static Project mockProject(File baseDir, List<File> sourceDirs, List<File> testDirs) {
    ...
    when(fileSystem.getTestFiles(mockMSBuildLanguage())).thenReturn(testSourceFiles);
    when(fileSystem.mainFiles(MSBuildPlugin.KEY)).thenReturn(mainFiles);
    when(fileSystem.testFiles(MSBuildPlugin.KEY)).thenReturn(testFiles);
